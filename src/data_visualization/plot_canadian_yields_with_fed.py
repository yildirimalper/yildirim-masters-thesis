...
plt.plot(data.index, data["10yr - 3dWindow Change Cumulative"], label="10y Canadian bond yield change around the Fed meetings", color="red")
plt.title("3-day windows around the Fed meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boc_mpd' / 'fed_3d_10y_1999_yield_in-window_cumulative_change.png')
plt.show()
...
plt.plot(data.index, data["10yr - Outside 3dWindow Change Cumulative"], label="10y Canadian bond yield change outside of Fed window", color="silver", alpha=0.9)
plt.title("Days outside 3-day Fed window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boc_mpd' / 'fed_3d_10y_1999_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.plot(data.index, data["10yr - 5dWindow Change Cumulative"], 
        label="10y Canadian bond yield change around the Fed meetings", color="red")
plt.title("5-day windows around the Fed meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boc_mpd' / 'fed_5d_10y_1999_yield_in-window_cumulative_change.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y Canadian bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 5dWindow Change Cumulative"], label="10y Canadian bond yield change outside of the Fed window", color="silver", alpha=0.9)
plt.title("Days outside 5-day Fed window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boc_mpd' / 'fed_5d_10y_1999_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boc_mpd' / 'fed_7d_10y_yield_in-window_cumulative_change.png')
plt.show()
...
plt.plot(data.index, data["10yr - Outside 7dWindow Change Cumulative"], 
        label="10y Canadian bond yield change outside of the Fed window", color="silver", alpha=0.9)
plt.title("Days outside 7-day Fed window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boc_mpd' / 'fed_7d_10y_yield_outside-window_cumulative_change.png')
plt.show()