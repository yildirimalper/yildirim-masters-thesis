...
data1y = pd.read_csv(PROJECT_DIR / "original_data" / "france1y.csv")
...
data2y = pd.read_csv(PROJECT_DIR / "original_data" / "france2y.csv")
...
data5y = pd.read_csv(PROJECT_DIR / "original_data" / "france5y.csv")
...
data10y = pd.read_csv(PROJECT_DIR / "original_data" / "france10y.csv")
...
data20y = pd.read_csv(PROJECT_DIR / "original_data" / "france20y.csv")
...
data30y = pd.read_csv(PROJECT_DIR / "original_data" / "france30y.csv")
...
data.to_csv(PROJECT_DIR / "processed_data" / "france_govt_bond_yields.csv", index=False)
data.to_pickle(PROJECT_DIR / "processed_data" / "france_govt_bond_yields.pkl")
