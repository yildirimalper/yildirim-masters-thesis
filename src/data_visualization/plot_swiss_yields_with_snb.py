...
plt.plot(data.index, data["10yr - 3dWindow Change Cumulative"], label="10y Swiss government bond yield change around the SNB meetings", color="red")
plt.title("3-day windows around the SNB meetings", fontsize=14)
...
# ===============================================================================
# Outside 3-day windows around the SNB meetings
# ===============================================================================
...
plt.plot(data.index, data["10yr - Outside 3dWindow Change Cumulative"], label="10y Swiss government bond yield change outside of SNB window", color="silver", alpha=0.9)
plt.title("Days outside 3-day SNB window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
...
plt.plot(data.index, data["10yr - 5dWindow Change Cumulative"], 
        label="10y Swiss government bond yield change around the SNB meetings", color="red")
plt.title("5-day windows around the SNB meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
...
# ===============================================================================
# Outside 5-day windows around the SNB meetings
# ===============================================================================
# Calculate the cumulative sum of these changes
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y Swiss government bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 5dWindow Change Cumulative"], label="10y Swiss government bond yield change outside of the SNB window", color="silver", alpha=0.9)
plt.title("Days outside 5-day SNB window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
...
plt.plot(data.index, data["10yr - 7dWindow Change Cumulative"], 
        label="10y Swiss government bond yield change around the SNB meetings", color="red")
plt.title("7-day windows around the SNB meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
...
# ===============================================================================
# Outside 7-day windows around the SNB meetings
# ===============================================================================
# Calculate the cumulative sum of these changes
...
plt.plot(data.index, data["10yr - Outside 7dWindow Change Cumulative"], 
        label="10y Swiss government bond yield change outside of the SNB window", color="silver", alpha=0.9)
plt.title("Days outside 7-day SNB window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
