...
plt.title("10y Canadian Bond Yields")
plt.tight_layout()
plt.show()
...
plt.plot(data.index, data["10yr - 3dWindow Change Cumulative"], label="10y Canadian bond yield change around the BoC meetings", color="red")
plt.title("3-day windows around the BoC meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boc_mpd' / 'boc_3d_10y_1999_yield_in-window_cumulative_change.png')
plt.show()

# ===============================================================================
# Outside 3-day windows around the BOC meetings
# ===============================================================================
...
# Plot the data
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y Canadian bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 3dWindow Change Cumulative"], label="10y Canadian bond yield change outside of BoC window", color="silver", alpha=0.9)
plt.title("Days outside 3-day BoC window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boc_mpd' / 'boc_3d_10y_1999_yield_outside-window_cumulative_change.png')
plt.show()

# ===============================================================================
# Plot 10y Canadian Cumulative Yield Change w.r.t. 5-day window
# ===============================================================================
...
plt.plot(data.index, data["10yr Change Cumulative"], 
        label="10y Canadian bond yield", color="dimgrey")
plt.plot(data.index, data["10yr - 5dWindow Change Cumulative"], 
        label="10y Canadian bond yield change around the BoC meetings", color="red")
plt.title("5-day windows around the BoC meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boc_mpd' / 'boc_5d_10y_1999_yield_in-window_cumulative_change.png')
plt.show()

# ===============================================================================
# Outside 5-day windows around the BoC meetings
# ===============================================================================
# Calculate the cumulative sum of these changes
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y Canadian bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 5dWindow Change Cumulative"], label="10y Canadian bond yield change outside of the BoC window", color="silver", alpha=0.9)
plt.title("Days outside 5-day BoC window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boc_mpd' / 'boc_5d_10y_1999_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.plot(data.index, data["10yr - 7dWindow Change Cumulative"], 
        label="10y Canadian bond yield change around the BoC meetings", color="red")
plt.title("7-day windows around the BoC meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boc_mpd' / 'boc_7d_10y_yield_in-window_cumulative_change.png')
plt.show()

# ===============================================================================
# Outside 7-day windows around the BoC meetings
# ===============================================================================
# Calculate the cumulative sum of these changes
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], 
        label="10y Canadian bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 7dWindow Change Cumulative"], 
        label="10y Canadian bond yield change outside of the BoC window", color="silver", alpha=0.9)
plt.title("Days outside 7-day BoC window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boc_mpd' / 'boc_7d_10y_yield_outside-window_cumulative_change.png')
plt.show()