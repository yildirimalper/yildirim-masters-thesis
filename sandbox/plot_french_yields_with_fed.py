...
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'FR_Fed_10y_yield_in-window_cumulative_change.png')
plt.show()
...
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'FR_Fed_10y_yield_outside-window_cumulative_change.png')
plt.show()