...
plt.plot(data.index, data["10yr - 3dWindow Change Cumulative"], label="10y UK gilt yield change around the BOE meetings", color="red")
plt.title("3-day windows around the BOE meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
#plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'boe_3d_10y_1997_yield_in-window_cumulative_change.png')
plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'boe_3d_10y_2008_yield_in-window_cumulative_change.png')
plt.show()

# ===============================================================================
# Outside 3-day windows around the BOE meetings
# ===============================================================================
...
plt.plot(data.index, data["10yr - Outside 3dWindow Change Cumulative"], label="10y UK gilt yield change outside of BOE window", color="silver", alpha=0.9)
plt.title("Days outside 3-day BOE window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
#plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'boe_3d_10y_1997_yield_outside-window_cumulative_change.png')
plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'boe_3d_10y_2008_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.plot(data.index, data["10yr - 5dWindow Change Cumulative"], 
        label="10y UK gilt yield change around the BOE meetings", color="red")
plt.title("5-day windows around the BOE meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
#plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'boe_5d_10y_1997_yield_in-window_cumulative_change.png')
plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'boe_5d_10y_2008_yield_in-window_cumulative_change.png')
plt.show()

# ===============================================================================
# Outside 5-day windows around the BOE meetings
# ===============================================================================
# Calculate the cumulative sum of these changes
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y UK gilt yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 5dWindow Change Cumulative"], label="10y UK gilt yield change outside of the BOE window", color="silver", alpha=0.9)
plt.title("Days outside 5-day BOE window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
#plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'boe_5d_10y_1997_yield_outside-window_cumulative_change.png')
plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'boe_5d_10y_2008_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.plot(data.index, data["10yr - 7dWindow Change Cumulative"], 
        label="10y UK gilt yield change around the BOE meetings", color="red")
plt.title("7-day windows around the BOE meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'boe_7d_10y_yield_in-window_cumulative_change.png')
plt.show()

# ===============================================================================
# Outside 7-day windows around the BOE meetings
# ===============================================================================
# Calculate the cumulative sum of these changes
...
plt.plot(data.index, data["10yr - Outside 7dWindow Change Cumulative"], 
        label="10y UK gilt yield change outside of the BOE window", color="silver", alpha=0.9)
plt.title("Days outside 7-day BOE window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'boe__7d_10y_yield_outside-window_cumulative_change.png')
plt.show()