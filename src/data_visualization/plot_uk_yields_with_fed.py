...
plt.tight_layout()
#plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed_3d_10y_1989_yield_in-window_cumulative_change.png')
#plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed_3d_10y_1997_yield_in-window_cumulative_change.png')
plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed_3d_10y_2008_yield_in-window_cumulative_change.png')
plt.show()
...
plt.legend(loc='lower left')
plt.tight_layout()
#plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed_3d_10y_1989_yield_outside-window_cumulative_change.png')
#plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed_3d_10y_1997_yield_outside-window_cumulative_change.png')
plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed_3d_10y_2008_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.legend(loc='lower left')
plt.tight_layout()
#plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed_5d_10y_1989_yield_in-window_cumulative_change.png')
#plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed_5d_10y_1997_yield_in-window_cumulative_change.png')
plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed_5d_10y_2008_yield_in-window_cumulative_change.png')
plt.show()
...
plt.legend(loc='lower left')
plt.tight_layout()
#plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed_5d_10y_1989_yield_outside-window_cumulative_change.png')
#plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed_5d_10y_1997_yield_outside-window_cumulative_change.png')
plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed_5d_10y_2008_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed_7d_10y_yield_in-window_cumulative_change.png')
plt.show()
...
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boe_mpd' / 'fed__7d_10y_yield_outside-window_cumulative_change.png')
plt.show()