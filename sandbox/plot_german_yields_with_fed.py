...
plt.title("10y Germany Government Bond Yield")
plt.tight_layout()
plt.show()
...
plt.plot(data.index, data["10y Yield - 3dWindow Change"], label="10y Treasury yield change around the Fed meetings", color="red")
plt.title("3-day windows around the Fed meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'DE_Fed_10y_yield_in-window_cumulative_change.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10y Yield Change"], label="10y Treasury yield", color="dimgrey")
plt.plot(data.index, data["10y Yield - 7dWindow Change"], label="10y Treasury yield change around the Fed meetings", color="red")
...
plt.plot(data.index, data["10y Yield - Outside 3dWindow Change"], label="10y Treasury yield change outside of the Fed window", color="silver", alpha=0.9)
plt.title("Days outside 3-day the Fed window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'DE_Fed_10y_yield_outside-window_cumulative_change.png')
plt.show()