...
data.to_csv(PROJECT_DIR / 'processed_data' / 'yield_data' / 'reg_australia_spot_yields.csv')
data.to_pickle(PROJECT_DIR / 'processed_data' / 'yield_data' / 'reg_australia_spot_yields.pkl')
