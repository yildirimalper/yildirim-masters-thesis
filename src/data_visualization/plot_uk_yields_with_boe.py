...
plt.tight_layout()
#plt.savefig(PROJECT_DIR / 'figs' / 'boe_mpd' / 'boe_3d_10y_1997_yield_in-window_cumulative_change.png')
plt.savefig(PROJECT_DIR / 'figs' / 'boe_mpd' / 'boe_3d_10y_2008_yield_in-window_cumulative_change.png')
plt.show()
...
plt.legend(loc='lower left')
plt.tight_layout()
#plt.savefig(PROJECT_DIR / 'figs' / 'boe_mpd' / 'boe_3d_10y_1997_yield_outside-window_cumulative_change.png')
plt.savefig(PROJECT_DIR / 'figs' / 'boe_mpd' / 'boe_3d_10y_2008_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.legend(loc='lower left')
plt.tight_layout()
#plt.savefig(PROJECT_DIR / 'figs' / 'boe_mpd' / 'boe_5d_10y_1997_yield_in-window_cumulative_change.png')
plt.savefig(PROJECT_DIR / 'figs' / 'boe_mpd' / 'boe_5d_10y_2008_yield_in-window_cumulative_change.png')
plt.show()
...
plt.legend(loc='lower left')
plt.tight_layout()
#plt.savefig(PROJECT_DIR / 'figs' / 'boe_mpd' / 'boe_5d_10y_1997_yield_outside-window_cumulative_change.png')
plt.savefig(PROJECT_DIR / 'figs' / 'boe_mpd' / 'boe_5d_10y_2008_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figs' / 'boe_mpd' / 'boe_7d_10y_yield_in-window_cumulative_change.png')
plt.show()
...
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figs' / 'boe_mpd' / 'boe__7d_10y_yield_outside-window_cumulative_change.png')
plt.show()