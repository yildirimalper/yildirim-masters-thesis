...
plt.plot(data.index, data["YC - Spot - 10y - 3dWindow Change Cumulative"], label="10y AAA-rated European bond yield change around ECB meetings", color="red")
...
plt.plot(data.index, data["YC - Spot - 10y - Outside 3dWindow Change Cumulative"], label="10y AAA-rated European bond yield change outside of ECB window", color="silver", alpha=0.9)
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["YC - Spot - 10y Change Cumulative"], label="10y AAA-rated European bond yield", color="dimgrey")
plt.plot(data.index, data["YC - Spot - 10y - 5dWindow Change Cumulative"], label="10y AAA-rated European bond yield change around ECB meetings", color="red")
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["YC - Spot - 10y Change Cumulative"], label="10y AAA-rated European bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["YC - Spot - 10y - Outside 5dWindow Change Cumulative"], label="10y AAA-rated European bond yield change outside of ECB window", color="silver", alpha=0.9)
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["YC - Spot - 10y Change Cumulative"], label="10y AAA-rated European bond yield", color="dimgrey")
plt.plot(data.index, data["YC - Spot - 10y - 7dWindow Change Cumulative"], label="10y AAA-rated European bond yield change around ECB meetings", color="red")
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["YC - Spot - 10y Change Cumulative"], label="10y AAA-rated European bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["YC - Spot - 10y - Outside 7dWindow Change Cumulative"], label="10y AAA-rated European bond yield change outside of ECB window", color="silver", alpha=0.9)
