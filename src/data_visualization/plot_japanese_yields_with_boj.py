...
plt.title("10y Japanese Government Bond Yield")
plt.tight_layout()
plt.show()
...
# Plot the data
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y Japanese government bond yield", color="dimgrey")
plt.plot(data.index, data["10yr - 3dWindow Change Cumulative"], label="10y Japanese government bond yield change around the BoJ meetings", color="red")
plt.title("3-day windows around the BoJ meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boj_mpd' / 'boj_3d_10y_yield_in-window_cumulative_change.png')
plt.show()

# ===============================================================================
# Outside 3-day windows around the BoJ meetings
# ===============================================================================
...
# Plot the data
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y Japanese government bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 3dWindow Change Cumulative"], label="10y Japanese government bond yield change outside of BOE window", color="silver", alpha=0.9)
plt.title("Days outside 3-day BoJ window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boj_mpd' / 'boj_3d_10y_yield_outside-window_cumulative_change.png')
plt.show()

# ===============================================================================
# Plot 10y Japanese Cumulative Yield Change w.r.t. 5-day window
# ===============================================================================
...
plt.plot(data.index, data["10yr Change Cumulative"], 
        label="10y Japanese government bond yield", color="dimgrey")
plt.plot(data.index, data["10yr - 5dWindow Change Cumulative"], 
        label="10y Japanese government bond yield change around the BOE meetings", color="red")
plt.title("5-day windows around the BoJ meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boj_mpd' / 'boj_5d_10y_yield_in-window_cumulative_change.png')
plt.show()

# ===============================================================================
# Outside 5-day windows around the BoJ meetings
# ===============================================================================
# Calculate the cumulative sum of these changes
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y Japanese government bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 5dWindow Change Cumulative"], label="10y Japanese government bond yield change outside of the BOE window", color="silver", alpha=0.9)
plt.title("Days outside 5-day BoJ window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boj_mpd' / 'boj_5d_10y_yield_outside-window_cumulative_change.png')
plt.show()

# ===============================================================================
# Plot 10y Japanese Cumulative Yield Change w.r.t. 7-day window
# ===============================================================================
...
plt.plot(data.index, data["10yr - 7dWindow Change Cumulative"], 
        label="10y Japanese government bond yield change around the BoJ meetings", color="red")
plt.title("7-day windows around the BoJ meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boj_mpd' / 'boj_7d_10y_yield_in-window_cumulative_change.png')
plt.show()

# ===============================================================================
# Outside 7-day windows around the BoJ meetings
# ===============================================================================
# Calculate the cumulative sum of these changes
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], 
        label="10y Japanese government bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 7dWindow Change Cumulative"], 
        label="10y Japanese government bond yield change outside of the BoJ window", color="silver", alpha=0.9)
plt.title("Days outside 7-day BoJ window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'boj_mpd' / 'boj_7d_10y_yield_outside-window_cumulative_change.png')
plt.show()
