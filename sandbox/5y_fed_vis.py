...
plt.plot(data.index, data["YC - Spot - 5y - 3dWindow Change"], label="5y Treasury yield change around the Fed meetings", color="red")
...
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'fed_3d_5y_yield_in-window_cumulative_change.png')
plt.show()
...
plt.plot(data.index, data["YC - Spot - 5y - Outside 3dWindow Change"], label="5y Treasury yield change outside of fed window", color="silver", alpha=0.9)
plt.title("Days outside 3-day the Fed window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.xlim(data.index.min(), datetime.datetime(2021, 6, 30))
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'fed_3d_5y_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["YC - Spot - 5y Change"], label="5y Treasury yield", color="dimgrey")
plt.plot(data.index, data["YC - Spot - 5y - 5dWindow Change"], label="5y Treasury yield change around the Fed meetings", color="red")
plt.title("5-day windows around the Fed meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.xlim(data.index.min(), datetime.datetime(2021, 6, 30))
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'fed_5d_5y_yield_in-window_cumulative_change.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["YC - Spot - 5y Change"], label="5y Treasury yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["YC - Spot - 5y - Outside 5dWindow Change"], label="5y Treasury yield change outside of fed window", color="silver", alpha=0.9)
plt.title("Days outside 5-day the Fed window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.xlim(data.index.min(), datetime.datetime(2021, 6, 30))
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'fed_5d_5y_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["YC - Spot - 5y Change"], label="5y Treasury yield", color="dimgrey")
plt.plot(data.index, data["YC - Spot - 5y - 7dWindow Change"], label="5y Treasury yield change around the Fed meetings", color="red")
plt.title("7-day windows around the Fed meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.xlim(data.index.min(), datetime.datetime(2021, 6, 30))
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'fed_7d_5y_yield_in-window_cumulative_change.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["YC - Spot - 5y Change"], label="5y Treasury yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["YC - Spot - 5y - Outside 7dWindow Change"], label="5y Treasury yield change outside of fed window", color="silver", alpha=0.9)
plt.title("Days outside 7-day the Fed window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.xlim(data.index.min(), datetime.datetime(2021, 6, 30))
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'fed_7d_5y_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["YC - Spot - 5y Change"], label="5y Treasury yield", color="dimgrey")
plt.plot(data.index, data["YC - Spot - 5y - 9dWindow Change"], label="5y Treasury yield change around the Fed meetings", color="red")
plt.title("9-day windows around the Fed meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.xlim(data.index.min(), datetime.datetime(2021, 6, 30))
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'fed_9d_5y_yield_in-window_cumulative_change.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["YC - Spot - 5y Change"], label="5y Treasury yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["YC - Spot - 5y - Outside 9dWindow Change"], label="5y Treasury yield change outside of fed window", color="silver", alpha=0.9)
plt.title("Days outside 9-day the Fed window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.xlim(data.index.min(), datetime.datetime(2021, 6, 30))
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'fed_9d_5y_yield_outside-window_cumulative_change.png')
plt.show()