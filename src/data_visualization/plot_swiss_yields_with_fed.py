...
data = data.loc[data.index >= '1993-01-01']
...
plt.title("10y Swiss Government Bond Yield")
plt.tight_layout()
plt.show()
...
# Plot the data
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y Swiss government bond yield", color="dimgrey")
plt.plot(data.index, data["10yr - 3dWindow Change Cumulative"], label="10y Swiss government bond yield change around the Fed meetings", color="red")
plt.title("3-day windows around the Fed meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'snb_mpd' / 'fed_3d_10y_yield_in-window_cumulative_change.png')
plt.show()
...
# Plot the data
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y AAA-rated European bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 3dWindow Change Cumulative"], label="10y AAA-rated European bond yield change outside of ECB window", color="silver", alpha=0.9)
plt.title("Days outside 3-day ECB window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'snb_mpd' / 'fed_3d_10y_yield_outside-window_cumulative_change.png')
plt.show()

# ===============================================================================
# Plot 10y Swiss Cumulative Yield Change w.r.t. 5-day window
# ===============================================================================
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y Swiss government bond yield", color="dimgrey")
plt.plot(data.index, data["10yr - 5dWindow Change Cumulative"], label="10y Swiss government bond yield change around the Fed meetings", color="red")
plt.title("5-day windows around the Fed meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'snb_mpd' / 'fed_5d_10y_yield_in-window_cumulative_change.png')
plt.show()
...
# Plot the data
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y Swiss government bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 5dWindow Change Cumulative"], label="10y Swiss government bond yield change outside of the Fed window", color="silver", alpha=0.9)
plt.title("Days outside 5-day the Fed window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'snb_mpd' / 'fed_5d_10y_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.plot(data.index, data["10yr Change Cumulative"], 
        label="10y Swiss government bond yield", color="dimgrey")
plt.plot(data.index, data["10yr - 7dWindow Change Cumulative"], 
        label="10y Swiss government bond yield change around the Fed meetings", color="red")
plt.title("7-day windows around the Fed meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'snb_mpd' / 'fed_7d_10y_yield_in-window_cumulative_change.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], 
        label="10y Swiss government bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 7dWindow Change Cumulative"], 
        label="10y Swiss government bond yield change outside of the Fed window", color="silver", alpha=0.9)
plt.title("Days outside 7-day Fed window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'snb_mpd' / 'fed_7d_10y_yield_outside-window_cumulative_change.png')
plt.show()