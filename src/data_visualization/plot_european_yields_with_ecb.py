...
plt.plot(data.index, data["10yr - 3dWindow Change Cumulative"], label="10y AAA-rated European bond yield change around ECB meetings", color="red")
plt.title("3-day windows around ECB meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'ecb_mpd' / 'ecb_3d_10y_yield_in-window_cumulative_change.png')
plt.show()
...
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'ecb_mpd' / 'ecb_3d_10y_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y AAA-rated European bond yield", color="dimgrey")
plt.plot(data.index, data["10yr - 5dWindow Change Cumulative"], label="10y AAA-rated European bond yield change around ECB meetings", color="red")
plt.title("5-day windows around ECB meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'ecb_mpd' / 'ecb_5d_10y_yield_in-window_cumulative_change.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y AAA-rated European bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 5dWindow Change Cumulative"], label="10y AAA-rated European bond yield change outside of ECB window", color="silver", alpha=0.9)
plt.title("Days outside 5-day ECB window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'ecb_mpd' / 'ecb_5d_10y_yield_outside-window_cumulative_change.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y AAA-rated European bond yield", color="dimgrey")
plt.plot(data.index, data["10yr - 7dWindow Change Cumulative"], label="10y AAA-rated European bond yield change around ECB meetings", color="red")
plt.title("7-day windows around ECB meetings", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'ecb_mpd' / 'ecb_7d_10y_yield_in-window_cumulative_change.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(data.index, data["10yr Change Cumulative"], label="10y AAA-rated European bond yield", color="dimgrey", alpha=0.9)
plt.plot(data.index, data["10yr - Outside 7dWindow Change Cumulative"], label="10y AAA-rated European bond yield change outside of ECB window", color="silver", alpha=0.9)
plt.title("Days outside 7-day ECB window", fontsize=14)
plt.ylabel("Cumulative Yield Change (%)", fontsize=12)
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig(PROJECT_DIR / 'figures' / 'ecb_mpd' / 'ecb_7d_10y_yield_outside-window_cumulative_change.png')
plt.show()

# Export data
data.to_pickle(PROJECT_DIR / 'processed_data' / 'data_with_ecb_10y_computations.pkl')